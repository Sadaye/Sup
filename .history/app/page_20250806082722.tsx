        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              {/* Sélecteur de thème (ampoule) */}
              {/* @ts-ignore: composant client */}
              {typeof window !== 'undefined' && require('@/components/theme/mode-toggle').ModeToggle()}
              {/* Bouton Connexion */}
              <Link href="/login" passHref legacyBehavior>
                <a className="text-gray-600 hover:text-blue-600 font-medium px-4 py-2 rounded transition">Connexion</a>
              </Link>
            </div>
          </div>
        </div>
