            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary text-white font-medium transition-all duration-300 hover:bg-yellow-400 hover:text-gray-900 focus:bg-yellow-400 focus:text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 focus:ring-offset-background shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
