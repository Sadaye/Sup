  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Accédez à la bibliothèque numérique de SupIGA : supports de cours, publications de recherche et ressources pédagogiques." />
      </Head>
      <div className="container mx-auto px-4 py-24 space-y-24">
        ...
        <section>
          ...
          >
            <Badge variant="outline" className="glass mb-4">Bibliothèque</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span>Centre de </span>
              <span className="text-gradient">ressources</span>
            </h1>
            <p className="text-lg text-muted-foreground">
              Accédez à notre bibliothèque numérique complète : supports de cours, 
              publications de recherche et ressources pédagogiques.
            </p>
          </motion.div>
        </section>
