      ...
      <div className="container relative z-10 mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            ...
            <span className="text-primary font-medium">Excellence académique depuis 2005</span>
          </motion.div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-foreground/80">+50 Formations</span>
            </div>
            <div className="flex items-center space-x-2">
              <Users className="h-5 w-5 text-primary" />
              <span className="text-sm text-foreground/80">+2000 Étudiants</span>
            </div>
            <div className="flex items-center space-x-2">
              <Award className="h-5 w-5 text-primary" />
              <span className="text-sm text-foreground/80">95% d&apos;insertion</span>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="glass-card aspect-video rounded-2xl overflow-hidden">
            <img 
              ...
              alt="Étudiants de SupIGA en cours" 
