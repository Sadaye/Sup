            ...
            <div className="grid md:grid-cols-3 gap-8 relative z-10">
              <div className="flex justify-center">
                <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white/20">
                  <img
                    ...
                    alt="Dr. Marie Laurent, Directrice de SupIGA"
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex flex-col">
                  <span className="font-semibold text-xl">Dr. Marie Laurent</span>
                  <span className="text-muted-foreground">Directrice de SupIGA</span>
                </div>
              </div>
            </div>
          </GlassCard>
