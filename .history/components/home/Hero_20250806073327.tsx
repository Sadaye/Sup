...
// Sous-composant pour le background
...
const stats = [
  { icon: BookOpen, label: "+30 Formations" },
  { icon: Users, label: "+1000 Étudiants" },
  { icon: Award, label: "80% d'insertion" },
];
...
// Sous-composant pour la carte flottante
        ...
        >
          <div className="glass-card aspect-video rounded-2xl overflow-hidden">
            <img
              ...
              aria-label="Photo du bâtiment principal de SupIGA"
            />
          </div>
          <FloatingStatsCard />
        </motion.div>
